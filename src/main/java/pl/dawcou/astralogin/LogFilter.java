...
public class LogFilter extends AbstractFilter {
    ...
    public Result filter(LogEvent event) {
        ...
        if (formatted.contains("issued server command:")) {
            ...
            if (lower.contains("/login ") || lower.contains("/l ") || lower.contains("/register ") || lower.contains("/reg ") ||
                ...
                if (action.equalsIgnoreCase("mask")) {
                    ...
                    ROOT_LOGGER.info(masked + HIDDEN_MARKER);
                    return Result.DENY;
                }
    ...
    private String maskPassword(String message) {
        ...
        String[] commands = {"/login", "/l", "/register", "/reg", "/zaloguj", "/zarejestruj", "/zmienhaslo", "/changepassword"};
